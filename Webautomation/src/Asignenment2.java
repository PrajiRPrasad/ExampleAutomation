...
import org.openqa.selenium.By;
 ...
 class Test2 {
	...
	{
		try {
			oBrowser.findElement(By.xpath("//span[text()='Customer1, Sample']")).click();
			oBrowser.findElement(By.name("lastName")).sendKeys("Customer2");
...
public class Asignenment2 {
	...
	public static void main(String[] args) {
		...
		Test2.deleteCustomer();
		Test2.ModifiedUser();
		Test2.logout();
		Test2.closeApplication();
